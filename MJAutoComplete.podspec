#
#  Be sure to run `pod spec lint MJAutoComplete.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "MJAutoComplete"
  s.version      = "1.0.0"
  s.summary      = "Simple drop-in for using autocomplete component on iOS."
  ...
  s.homepage     = "https://github.com/Mazyod/MJAutoComplete"
  s.screenshots  = "https://raw.githubusercontent.com/Mazyod/MJAutoComplete/master/resources/MJAutoComplete-demo.gif"
  ...
  s.source       = { :git => "https://github.com/Mazyod/MJAutoComplete.git", :tag => "1.0.0" }
